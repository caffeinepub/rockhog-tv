      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          ...
          <span className="font-semibold text-primary">
            {balance !== undefined ? Number(balance).toLocaleString() : "0"}
          </span>{" "}
          Bacon Cash
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Submit a request to purchase Bacon Cash. An admin will process
              your request.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full"
                disabled={requestBaconCash.isPending}
              >
